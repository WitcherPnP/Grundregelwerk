...
\hline
\textbf{Fortgeschrittene Kampfkunst} & Ermöglicht die Kampfaktionen \textit{Schwung-Angriff}, \textit{Entwaffnung}, \textit{Auchweichrolle} und \textit{Parieren} & Kann nur von kampfbezogenen Klassen verwendet werden. +6 auf \textit{Raufen} und \textit{Kampftechnik}. \\

\hline 
\textbf{Meisterliche Kampfkunst} & Die Erschwernis beim Standhalten von aufeinander folgenden Schlägen wird anstatt um 2, um 1 pro Stufe erhöht. & \textit{Forgeschrittene Kampfkunst} muss bereits erlernt sein. \\
